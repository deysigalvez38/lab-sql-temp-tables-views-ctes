#Paso 1: Crear una VIEW con el resumen de alquileres por cliente
use sakila;
...
#Paso 2: Crear una TEMPORARY TABLE con el total pagado por cliente
...
#Paso 3: Crear un CTE y generar el informe final
